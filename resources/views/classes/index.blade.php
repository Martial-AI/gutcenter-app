...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (createForm) {
        ...
        const monthlyAmountLabel = document.createElement('label'); monthlyAmountLabel.innerHTML = `{{ __('Monthly school fee') }}<input type="number" min="0" step="0.01" name="monthly_fee_amount" placeholder="Montant en Ariary" class="mt-1 block w-full rounded border-gray-300">`; createForm.querySelector('.grid').appendChild(monthlyAmountLabel);
